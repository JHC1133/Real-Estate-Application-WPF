...
namespace Modern_Real_Estates_by_Joar_H_C.Buildings.ResidentialBuildings
{
    ...
    {
        public Villa(string street, string city, string zipcode, int numberOfBedrooms, int numberOfBathrooms, bool hasGarage) : base(street, city, zipcode, numberOfBedrooms, numberOfBathrooms, hasGarage)
        {
        }
